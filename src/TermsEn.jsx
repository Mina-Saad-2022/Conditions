...
function App() {
  return (
    <div className="page">
        ...
        />
        <h1 className="m-2">Terms and Conditions</h1>
      </div>
      <h4 className="text-danger p-2">
        Welcome to our website. By using this site, you agree to the following
        terms:
      </h4>
      <ul className="list-unstyled p-2">
        <li className="h6 p-2">A</li>
        <li className="h6 p-2">B</li>
        <li className="h6 p-2">C</li>
        <li className="h6 p-2">D</li>
        <li className="h6 p-2">A</li>
        <li className="h6 p-2">B</li>
        <li className="h6 p-2">C</li>
        <li className="h6 p-2">D</li>
